...
export class AsesorVehiculoController {
  ...
  async find(
    ...
    return this.asesorRepository.asesorVehiculos(id).find(filter);
  }
  ...
  async create(
    ...
    return this.asesorRepository.asesorVehiculos(id).create(vehiculo);
  }
  ...
  async patch(
    ...
    return this.asesorRepository.asesorVehiculos(id).patch(vehiculo, where);
  }
  ...
  async delete(
    ...
    return this.asesorRepository.asesorVehiculos(id).delete(where);
  }
}
