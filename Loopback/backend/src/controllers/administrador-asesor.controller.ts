...
export class AdministradorAsesorController {
  ...
  async find(
    ...
    return this.administradorRepository.adminAsesores(id).find(filter);
  }
  ...
  async create(
    ...
    return this.administradorRepository.adminAsesores(id).create(asesor);
  }
  ...
  async patch(
    ...
    return this.administradorRepository.adminAsesores(id).patch(asesor, where);
  }
  ...
  async delete(
    ...
    return this.administradorRepository.adminAsesores(id).delete(where);
  }
}
