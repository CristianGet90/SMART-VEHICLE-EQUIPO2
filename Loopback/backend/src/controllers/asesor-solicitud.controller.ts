...
export class AsesorSolicitudController {
  ...
  async find(
    ...
    return this.asesorRepository.asesorSolicitud(id).find(filter);
  }
  ...
  async create(
    ...
    return this.asesorRepository.asesorSolicitud(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.asesorRepository.asesorSolicitud(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.asesorRepository.asesorSolicitud(id).delete(where);
  }
}
