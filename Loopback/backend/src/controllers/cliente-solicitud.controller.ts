...
export class ClienteSolicitudController {
  ...
  async find(
    ...
    return this.clienteRepository.clienteSolicitud(id).find(filter);
  }
  ...
  async create(
    ...
    return this.clienteRepository.clienteSolicitud(id).create(solicitud);
  }
  ...
  async patch(
    ...
    return this.clienteRepository.clienteSolicitud(id).patch(solicitud, where);
  }
  ...
  async delete(
    ...
    return this.clienteRepository.clienteSolicitud(id).delete(where);
  }
}
